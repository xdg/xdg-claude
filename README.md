...
| [**design-docs**](design-docs/README.md) | | ✓ | | ✓ | Draft, amend, and close out the document ladder (PRD, milestone system design, inchstone spec) one rung per invocation, with closeout that harvests what the work taught into living docs |
