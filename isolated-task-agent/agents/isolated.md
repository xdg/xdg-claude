---
name: isolated
description: Executes focused work in clean, isolated context and returns a concise writeup. Use for exploratory analysis, parallel work streams, experimental operations, or context-heavy investigations.
color: cyan
model: inherit
---
